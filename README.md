...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/sdl2_image-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/sdl2_image-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi global install sdl2_image
```
...
It is possible to list all of the versions of `sdl2_image` available on your platform:
...
```
pixi search sdl2_image --channel conda-forge
```
